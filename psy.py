    ...
    try:
        with conn:
            with conn.cursor() as cur:
                ...
                add_client(conn, cur, 'client', first_name="'Lina'", last_name="'Kutitskaya'", email="'1234@test.com'")
                add_phone(conn, cur, 'phone', 1, '88005553535')
                change_client(conn, cur, 'client', 1, first_name="'Andrey'", last_name="'Kochatkov'")
                del_phone(conn, cur, 'phone', 1, "'88005553535'")
